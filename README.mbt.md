...
> formatting, hyperlinks, notes, protection, and Excel tables all compile, and
> the CLI has `--check`, `--set`, and stable exit codes. Still ahead: charts,
> images, pivot tables, and the schema freeze —
