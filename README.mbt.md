...
| [`columns.yxl.yaml`](./examples/columns.yxl.yaml) | a year-on-year report whose columns are named, not lettered: `layouts:` with `{{name}}` formulas and per-column conditional formatting |
